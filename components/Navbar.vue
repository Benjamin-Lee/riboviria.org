        ...
        <div class="flex">
          <div class="flex-shrink-0 flex items-center">
            ...
            <img
              ...
              alt="Workflow"
            /> -->
            <span class="text-xl font-extrabold text-gray-900 tracking-wide"
              >RVMT</span
            >
          </div>
          <div class="hidden sm:ml-10 sm:flex sm:space-x-10">
...
nav .nuxt-link-exact-active {
  @apply border-green-500 text-gray-900 hover:border-green-500 hover:text-gray-900;
}
